...
namespace mesh {
    namespace connectivity {
        ...
        void nrf_pipe::setNrfAddress(const nrf24l01::nrf_address &nrfAddress) {
        ...
        const nrf24l01::nrf_address &nrf_pipe::getNrfAddress() const {
            return nrf_address;
        }
        ...
        hwlib::ostream &operator<<(hwlib::ostream &os, const nrf_pipe &pipe) {
            os << "connection_state: " << pipe.connection_state << " pipe_number: " << pipe.pipe_number
               << " connected_node: " << hwlib::hex << pipe.connected_node << " nrf_address: "
